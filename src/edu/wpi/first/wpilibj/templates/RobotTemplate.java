/*----------------------------------------------------------------------------*/
/* Copyright (c) FIRST 2008. i9iAll Rights Reserved.                             */
...
//    DigitalChannel x = new DigitalChannel(6);
    /**
  ...
  boolean runauto;
            ...
            runauto=true;
        while (runauto==true){
 //           TalonUp.set(0.67); //talon speed in
        //    chassis.setLeftRightMotorOutputs(0.1, 0.1);
         //   chassis.drive(1.0, 1.0);
  //          Timer.delay(2.0); //talon up to speed time
   //         JaguarL.set(1.0); // arm back speed
          //  chassis.drive(0.0, 0.0);
  //          Timer.delay(.75); //arm time
   //         JaguarL.set(0); 
    //        TalonUp.set(0);
         //   chassis.drive(1.0, 0.0);
  //          Timer.delay(1.0); //delay before 
    //        TalonUp.set(-0.75);
   //         TalonDown.set(0.75);
     //       Timer.delay(2.0);
     //       JaguarL.set(1.0);
